                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3 d-flex justify-content-end">
                            <a href="{{ route('admin.trading.export') }}?{{ http_build_query(request()->query()) }}" class="btn btn-primary">Excel</a>
                        </div>
                            ...
                            <table class="table text-nowrap align-middle mb-0 table-striped table-hover">
                                <thead>
                                    <tr class="border-2 border-bottom border-primary border-0">
                                        ...
                                        <th scope="col" class="text-center">자산종류</th>
                                        <th scope="col" class="text-center">퀀트횟수</th>
                                ...
                                <tbody class="table-group-divider">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col" class="text-center">{{ $value->balance }}</td>
                                        <td scope="col" class="text-center">{{ $value->profits->sum('profit') }}</td>
                                        <td scope="col" class="text-center">{{ $value->profit_rate }}</td>
